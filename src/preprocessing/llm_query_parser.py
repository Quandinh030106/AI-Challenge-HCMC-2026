...
class LLMQueryParser:
    ...
    def parse_query_dynamically(self, query_vi, task_type="kis", raw_question=""):
        ...
        system_prompt = (
            ...
            "5. 'bm25_keywords': Mảng chứa TOÀN BỘ CÂU TIẾNG VIỆT GỐC và các CỤM DANH TỪ CỐT LÕI (2-4 từ/cụm, ví dụ: 'dán niêm phong', 'thùng carton', 'trái măng cụt', 'thùng mì tôm', 'đua xe đạp'). TUYỆT ĐỐI KHÔNG xé lẻ thành từng từ đơn rác.\n"
            "6. 'openimages_classes': Mảng danh từ Tiếng Anh đại diện cho VẬT THỂ THỂ LÝ nhìn thấy được ('person', 'box', 'fruit', 'bottle', 'car', 'motorcycle', 'scale', 'drum', 'piano', 'sign'). TUYỆT ĐỐI KHÔNG chứa tính từ, động từ, hoặc khái niệm trừu tượng.\n"
