...
class LLMQueryParser:
    ...
    def parse_query_dynamically(self, query_vi, task_type="kis", raw_question=""):
        ...
        system_prompt = (
            ...
            "     + BẮT BUỘC giữ đúng toàn bộ các danh từ vật thể và hành động thực tế bằng cụm Tiếng Anh tự nhiên (Ví dụ: 'two women sealing a cardboard carton box with tape').\n"
            ...
            "     + 'cá hồi' -> 'salmon fish' / 'cooked salmon'\n"
            "     + 'cá sòng' -> 'mackerel fish' / 'scad fish'\n"
            "     + 'nghêu' / 'nghêu sữa' -> 'clams' / 'white clams'\n"
            ...
            "     + 'khuôn bánh' -> 'cake mold' / 'waffle maker'\n"
            "     + 'cân điện tử' / 'cân đồng hồ' -> 'weighing scale'\n"
            "     + 'biển tên đường' -> 'street name sign'\n"
            "5. 'bm25_keywords': Mảng chứa TOÀN BỘ CÂU TIẾNG VIỆT GỐC và các CỤM DANH TỪ CỐT LÕI (2-4 từ/cụm, ví dụ: 'dán niêm phong', 'thùng carton', 'trái măng cụt', 'thùng mì tôm', 'đua xe đạp', 'cá hồi', 'nghêu sữa'). TUYỆT ĐỐI KHÔNG xé lẻ thành từng từ đơn rác.\n"
            "6. 'openimages_classes': Mảng danh từ Tiếng Anh đại diện cho VẬT THỂ THỂ LÝ nhìn thấy được ('person', 'box', 'fruit', 'fish', 'bottle', 'car', 'motorcycle', 'scale', 'drum', 'piano', 'sign'). TUYỆT ĐỐI KHÔNG chứa tính từ, động từ, hoặc khái niệm trừu tượng.\n"
